...
1. open file [[./mtab]]
2. *copy its contents*
3. open your browser and option in extention mtab, it will look something like this
[[./mtab_options.jpg]]
4. and finaly scroll to the very bottom, there click the button *import & save* and paste the contents of the config
** P.S.
